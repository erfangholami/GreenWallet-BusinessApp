...
data class CampaignsResponseModel(
    ...
    @SerializedName("inspiration_ids") var inspirationIds: Array<String>? = null,
    @SerializedName("inspiration_urls") var inspirationUrls: Array<String>? = null,
